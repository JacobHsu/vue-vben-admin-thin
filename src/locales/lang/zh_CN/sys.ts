export default {
  ...
  app: { logoutTip: '溫馨提醒', logoutMessage: '是否確認退出係統?', menuLoading: '菜單加載中...' },
  errorLog: {
    tableTitle: '錯誤日誌列錶',
    tableColumnType: '類型',
    tableColumnDate: '時間',
    ...
    enableMessage: '隻在`/src/settings/projectSetting.ts` 內的useErrorHandle=true時生效.',
  },
  exception: {
    backLogin: '返回登錄',
    backHome: '返回首頁',
    subTitle403: '抱歉，您無權訪問此頁麵。',
    subTitle404: '抱歉，您訪問的頁麵不存在。',
  ...
  login: {
    ...
    signInDesc: 'vben-admin-thin-next hello world',
    policy: '我同意xxx隱私政策',
